...
const authenticate = exports.authenticate = authToken => {
  ...
  activeDomain[sessionSymbol].authData = jwt.verify(authToken, process.env.SECRET)
}
...
exports.getCorrelationId = () => {
  if (process.domain[sessionSymbol]) {
